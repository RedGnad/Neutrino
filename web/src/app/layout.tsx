      ...
      <body className="min-h-full">
        ...
        >
          <div className="mx-auto flex min-h-14 max-w-6xl items-center justify-between gap-3 px-4 py-3 sm:px-6">
            <Link
              href="/"
              className="brand-lockup flex shrink-0 items-center gap-3"
            >
              <svg
              ...
              >
                ...
                <path
                  ...
                  d="M8 25 L8 8 C8 6 24 6 24 14 L24 25"
                  fill="none"
                  strokeWidth="2.8"
              ...
              <span className="brand-wordmark">Neutrino</span>
              <span
                ...
                style={{
                  ...
                  background:
                    "color-mix(in srgb, var(--clear) 9%, transparent)",
                  color: "var(--clear)",
                  border:
                    "1px solid color-mix(in srgb, var(--clear) 26%, transparent)",
                }}
              >
                mainnet
              </span>
        ...
        >
          <div className="flex flex-wrap items-center justify-between gap-3">
            ...
            >
              schema: neutrino.decision.v3 · engine: deterministic · narration:
              claude-haiku-4-5
            </span>
          </div>
        </footer>
